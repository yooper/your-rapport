...
export const discoveryPluginSchema = z.object({
  ...
  action: z.enum(["CreateTab", "SubmitForm", "ForegroundRunner", "BackgroundRunner"]),
  ...
  timeOut: z.number().int().min(0).max(300000),       // 0..5 minutes; adjust to your needs
  ...
  contentTypeHeader: z.enum(["", "application/json", "multipart/form-data", "application/octet-stream", "application/x-www-form-urlencoded"]).nullable(),
