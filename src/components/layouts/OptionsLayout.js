...
export default function OptionsLayout() {
  ...
  const [selectedComponent, setSelectedComponent] = useState(urlParams.get('view') ?? 'browser')

  const componentMap = [
    { label: 'Browser Settings', key: 'browser', message: 'Modify browser specific settings' },
    { label: 'Discovery Plugins', key: 'discovery_plugin', message: 'Connect or enrich your data to other service providers. Autolinks data repositories to your selectors.'},
    { label: 'Package Management', key: 'package_management', message: 'Packages enhance and extend Your Rapport functionality. When you install a package it becomes a discovery plugin. Discovery plugins help you search for selectors.'},
    { label: 'Selectors', key: 'selector', message: 'Create or Delete selectors'},
  ]
