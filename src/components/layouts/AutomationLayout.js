...
export default function AutomationLayout() {
  ...
  const [selectedComponent, setSelectedComponent] = useState(urlParams.get('view') ?? 'bulk_automation')

  const componentMap = [
    { label: 'Bulk Automation', key: 'bulk_automation', message: 'Insert a list of urls that will be opened in a tab and collected' },
    { label: 'Scheduled Automation', key: 'scheduled_automation', message: 'TODO: implement scheduling collection subsystem'},
    { label: 'Selector Automation', key: 'selector_automation', message: 'TODO: Discover selectors on a live page'},
  ]
