    ...
    <Fragment>
      {uxType === 'chip' ? (
        <Chip
          ...
          size="small"
          onDelete={
            Object.keys(getSelectorTypeMap()).includes(title)
              ? async () => {
                  await handleDelete(pluginValue);
                }
              : null
          }
        />
                              ...
                              onClick={() => {
                                try {
                                  ...
                                  processNotification({
                                    ...
                                    message:
                                      'You will need to buy a pro license to use this feature',
                                    type: 'danger',
                                  });
                                }
                              }}
