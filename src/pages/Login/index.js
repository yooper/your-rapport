...
export default function Login() {
  ...
  const handleSubmit = async(event) => {
    ...
    if(!validateEmail(email)){
        processNotification({title: "Valid Email Required", message: "You must supply a valid email", type: 'danger'});
        return;
    }
      ...
      <Container component="main" maxWidth="xl" sx={{ minWidth: 580 }}>
        ...
        >
          ...
          >
            ...
            />
            <input type={'hidden'} value={`chrome-extension://${chrome.runtime.id}`} name={'ExtensionId'} />
            <Button
              type="submit"
              fullWidth
              variant="contained"
